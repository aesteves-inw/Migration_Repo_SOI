...
public class SOI_3604 {

	public static void SOI_3604_TC01_DS_CopyProvisioningContact_ProductBasket2Service(
	...
	public static void SOI_3604_TC02_DS_CopyProvisioningContact_ProductBasket2Service_Negative(
			List<TestStepReportStructure> testExecStructure, List<TestLog> logStream, WebDriver driver,
			String testName) throws Exception 
	{
		String productName ="Phone Line";
	...
	public static void SOI_3604_TC03_PC_CopyProvisioningContact_ProductBasket2Service(
			List<TestStepReportStructure> testExecStructure, List<TestLog> logStream, WebDriver driver,
			String testName) throws Exception 
	{
	...
	public static void SOI_3604_TC04_PC_CopyProvisioningContact_ProductBasket2Service_Negative(
			List<TestStepReportStructure> testExecStructure, List<TestLog> logStream, WebDriver driver,
			String testName) throws Exception
	{
		String user="farmerUser";
