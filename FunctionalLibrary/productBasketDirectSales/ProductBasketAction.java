...
public class ProductBasketAction {
	...
	public static void changeToProductBasketiFrame(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
...
//			WebElement iframeProductBasket = driver.findElement(By.xpath(DirSalesProductBasket.iframeProductBasket));
			...
			Boolean existIframeDS = driver.findElements(By.xpath(DirSalesProductBasket.iframeProductBasket))
					.size() != 0;

			Boolean existIframePC = driver
					.findElements(By.xpath("//iframe[@title='Visualforce Page component container']")).size() != 0;
			...
			if (existIframeDS == true) {
				...
				iframeProductBasket = driver
						.findElement(By.xpath("//iframe[@title='Visualforce Page component container']"));
...
//			System.out.println("no. of iframes are " + numberOfFrames2);
			...
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath(DirSalesProductBasket.productBasketLabel)));
	...
	public static void changeToProductBasketiFramePC(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, 30);
	...
	public static void syncProductBasket(List<TestLog> logStream, WebDriver driver, int newStepCounter)
			throws Exception {
	...
	public static void selectLineItem(List<TestLog> logStream, WebDriver driver, int newStepCounter, String productName)
			throws Exception {
...
//			List<WebElement> productBasketLineItem=driver.findElements(By.xpath("//li[@role='treeitem']"));
			...
			for (WebElement we : productBasketLineItem) {
				if (we.getText().contains(productName)) {
					...
					WebElement selectLineItemCheckBox = we
							.findElement(By.xpath(DirSalesProductBasket.selectLineItemCheckBox));
	...
	public static void deleteLineItem(List<TestLog> logStream, WebDriver driver, int newStepCounter) throws Exception {
		...
		try {
			WebElement deleteButton = new WebDriverWait(driver, 5)
					.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@aria-label='Delete Product']")));

			deleteButton.click();

			new WebDriverWait(driver, 5)
					.until(ExpectedConditions.elementToBeClickable(By.xpath("//h3[text()='Delete Product']")));

			driver.findElement(
					By.xpath("//span[@ng-bind='::LabelsConstant.DELETE_PRODUCTS_CONFIRMATION_DIALOG.BTN_OK']")).click();
	...
	public static void expandingECS(List<TestLog> logStream, WebDriver driver, int stepID, String productName)
			throws Exception {
	...
	public static void goToEditProductConfigurationECS(List<TestLog> logStream, WebDriver driver, int stepID,
			String productName, String productToConfig) throws Exception {
		...
		try {
			...
			/*
			 * WebElement
			 * productBasketTable=driver.findElement(By.xpath(DirSalesProductBasket.
			 * productBasketTable));
			 * 
			 * List<WebElement>
			 * productBasketLines=productBasketTable.findElements(By.tagName("li"));
			 * 
			 * for (WebElement we:productBasketLines) { if
			 * (we.getText().contains(productName)) {
			 * we.findElement(By.xpath(DirSalesProductBasket.editProductConfigurationButton)
			 * ).click(); break; } }
			 */
			 ...
			 * 
			 * List<WebElement>
			 * productBasketLinesBts=productBasketTable.findElements(By.xpath(
			 * DirSalesProductBasket.editProductConfigurationButton));
			 * 
			 * for(int i=0;i<productBasketLines.size();i++) {
			 * System.out.println(productBasketLines.get(i).getText()); if
			 * (productBasketLines.get(i).getText().contains(productToConfig)) {
			 * productBasketLinesBts.get(i).click();
			 * 
			 * //BrowserActions.jsClick(driver, productBasketLinesBts.get(i)); break; } }
			 */
			switch (productToConfig) {

			case "FullFiber Extended":
				driver.findElement(By.xpath(
						"//*[@id=\"basket-table\"]/div[2]/div/ul/li[1]/div/div/div/div[3]/ul/li[1]/div/div/div/div[2]/ul/li/div/div/div/div/div[7]/button"))
						.click();
				break;
			...
			case "Enterprise Voice - Converged":
				driver.findElement(By.xpath(
						"//*[@id=\"basket-table\"]/div[2]/div/ul/li[1]/div/div/div/div[3]/ul/li[2]/div/div/div/div[2]/ul/li/div/div/div/div/div[7]/button"))
						.click();
				break;
...
//						.click();
			...
			new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath(DirSalesEditProductConfiguration.iFrameEditProductConfiguration)));
	...
	public static void goToEditProductConfiguration(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			...
			List<WebElement> productBasketLinesBts = productBasketTable
	...
	public static void goToDiscountManagementConsole(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static void goToOrderEnrichmentConsole(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static void fillExistingBillingAccountIdField(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			...
			WebElement inputExistingBillingAccountIdField = driver
					.findElement(By.xpath(DirSalesProductBasket.inputExistingBillingAccountId));
	...
	public static void fillExistingTechnicalContact(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			/*
			 * WebElement inputProvisioningContact =
			 * driver.findElement(By.xpath(DirSalesProductBasket.
			 * inputProvisioningContactPerson));
			 * 
			...
			/*
			 * List<WebElement> provlistItem= new WebDriverWait(driver,
			 * 15).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(
			 * "//li/div/div[1]")));
			 * 
			 * for(int i=0;i<provlistItem.size();i++) { String
			 * validation=provlistItem.get(i).getText().toString();
			 * 
			...
			// WebElement provlistItem = new WebDriverWait(driver,
			// 15).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li/div/div[1]")));
			changeToDefaultiFrame(logStream, driver, stepID);
			...
			WebElement provlistItem = new WebDriverWait(driver, 15).until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"select2-results-6\"]/li[1]")));
	...
	public static void saveProductBasketChanges(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static void saveEditProductBasketChanges(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static void cancelProductBasketChanges(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static void fillNewBillingAccountAddress(List<TestLog> logStream, WebDriver driver, int stepID,
			String newBillingAddress) throws Exception {
		String actionName = "fillNewBillingAccountAddress";

		try {
			driver.findElement(By.xpath(DirSalesProductBasket.inputNewBillingAccountAddress))
					.sendKeys(newBillingAddress);
	...
	// Validation Actions
	public static boolean productBasketScreenValidation(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
...
//		    System.out.println("Element Sync is in current iFrame: --" + BrowserActions.isElementPresent(driver, DirSalesProductBasket.syncButton));
	...
	public static boolean productBasketScreenValidationPC(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		String actionName = "Product Basket: Validation of Product Basket Screen";
	...
	public static boolean validateProductBasketScreen(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		String actionName = "Product Basket: Validation of Product Basket Screen";
		...
		try {
			if (// BrowserActions.isElementPresent(driver,
				// DirSalesProductBasket.cloneBasketButton) &&
				// BrowserActions.isElementPresent(driver, DirSalesProductBasket.syncButton))
				// //&&
				// BrowserActions.isElementPresent(driver,
				// DirSalesProductBasket.productBasketHeader) &&
				// BrowserActions.isElementPresent(driver,
				// DirSalesProductBasket.productBasketName) &&
			BrowserActions.isElementPresent(driver, DirSalesProductBasket.addProductButton)) {
				TestLogger.logTrace(logStream, actionName, "Succeeded in Step: " + stepID);
	...
	public static boolean productOnProductBasketNegativeValidation(List<TestLog> logStream, WebDriver driver,
			int stepID, String productName) throws Exception {
	...
	public static boolean syncProductBasketPosVal(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	public static boolean syncProductBasketNegVal(List<TestLog> logStream, WebDriver driver, int newStepCounter)
			throws Exception {
	...
	private static boolean validateExpandedECSProPlusPhoneLine(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		...
		try {
			List<WebElement> ecsProductExpanded = new WebDriverWait(driver, 30)
					.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//li[@class='ng-scope']")));

			for (WebElement we : ecsProductExpanded) {
				if (we.getText().contains("Internet Pro+") || we.getText().contains("Phone Line")
						|| we.getText().contains("Business Continuity")) {
					validation++;
				}
			}
	...
	private static boolean validateExpandedECSProPhoneLine(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	private static boolean validateExpandedECSProEV(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	private static boolean validateExpandedECSProPlusEV(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
	...
	private static boolean validateExpandedECSFullFiber(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		...
		try {
			...
			for (WebElement we : ecsProductExpanded) {
				if (we.getText().contains("FullFiber") || we.getText().contains("Enterprise Voice - Converged")
						|| we.getText().contains("Business Continuity")) {
					validation++;
				}
			}
	...
	private static boolean validateExpandedECSFullFiberExtended(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		...
		try {
			...
			for (WebElement we : ecsProductExpanded) {
				if (we.getText().contains("FullFiber Extended") || we.getText().contains("Enterprise Voice - Converged")
						|| we.getText().contains("Business Continuity")) {
					validation++;
				}
			}
	...
	public static boolean checkExistingBillingAccountIdField(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			WebElement inputExistingBillingAccountId = driver
					.findElement(By.xpath(DirSalesProductBasket.inputExistingBillingAccountId));

			System.out.println("Debug of inputExistingBillingAccountId.getText().toString() after val: "
					+ inputExistingBillingAccountId.getAttribute("value"));
	...
	public static boolean internetEditConfigValidation(List<TestLog> logStream, WebDriver driver, int stepID)
			throws Exception {
		...
		try {
			...
			String internetEditConfigHeader1 = driver.findElement(By.xpath("//p[text()='Product Configuration']"))
					.getText();
			String internetEditConfigHeader2 = driver
					.findElement(By.xpath("//h1[text()='ECS - Professional Internet']")).getText();

			// if(internetEditConfigHeader1 == "Product Configuration" ||
			// internetEditConfigHeader2 == "ECS - Professional Internet")
			if (driver.findElement(By.xpath("//p[text()='Product Configuration']")).isDisplayed()
					|| driver.findElement(By.xpath("//h1[text()='ECS - Professional Internet']")).isDisplayed()) {
				TestLogger.logTrace(logStream, actionName, "Succeeded in Step: " + stepID);
				return true;
			} else {
				return false;
	...
	public static boolean checkExistingTechnicalContact(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			...
			WebElement inputCheck = driver.findElement(
					By.xpath("//div[@class='select2-container select2-allowclear ng-pristine ng-untouched ng-valid']"));
	...
	public static boolean fillNewBillingAccountAddressValidation(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			String newBillingAddressVal = driver
					.findElement(By.xpath(DirSalesProductBasket.inputNewBillingAccountAddress)).getAttribute("value");
	...
	public static boolean selectAddressEditProduct(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			BrowserActions.ScrollByElement(driver, "xpath",
					"//*[@id=\"configurationContainer\"]/div/div/div[2]/div[3]/h3");
			...
			WebElement addressSelect = new WebDriverWait(driver, 10).until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//div[contains(text(),'" + address + "')]")));
	...
	public static boolean technologyValidationOCK(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			driver.findElement(By.xpath(
					"//*[@id=\"s2id_Enterprise_Call___Surf_Internet:ECS_Pack_Installation_Address___OCK_Check:accessTechnology_0\"]"))
					.click();

			WebElement technologySelect = new WebDriverWait(driver, 10).until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@id='select2-drop']//ul)[2]")));
			...
			case "FIBER":
				...
				break;
			case "BOTH":
				if (technologyList.contains("VDSL2")
						|| technologyList.contains("ADSL2+E") && technologyList.contains("GPON")) {
					TestLogger.logTrace(logStream, actionName, "Succeeded in Step: " + stepID);
					validation = true;
					driver.findElement(By.xpath("//*[@id=\"select2-results-1\"]/li[1]")).click();
				} else {
	...
	public static void fillProvisioningContactPerson(List<TestLog> logStream, WebDriver driver, int stepID,
		...
		try {
			WebElement inputProvisioningContactPerson = driver
					.findElement(By.xpath(DirSalesProductBasket.inputProvisioningContactPerson));
			...
			new WebDriverWait(driver, 15).until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath("//div[contains(text(),'" + textProvisioningContactPersonField + "')]"))).click();
			;
	...
	public static boolean checkProvisioningContactPersonFieldDetails(List<TestLog> logStream, WebDriver driver,
			int stepID, String textProvisioningContactPersonField) throws Exception {
		String actionName = "checkProvisioningContactPersonFieldDetails";
		try {
			WebElement inputProvisioningContactPerson = driver
					.findElement(By.xpath(DirSalesProductBasket.inputProvisioningContactPerson));

			System.out.println("Debug of inputProvisioningContactPerson.getText().toString() after val: "
					+ inputProvisioningContactPerson.getAttribute("value"));
	...
	private static void displayLineItemsTable(List<TestLog> logStream, WebDriver driver, int stepID) throws Exception {

		String actionName = "displayLineItemsTable";

		try {
			Thread.sleep(5000);

			new WebDriverWait(driver, 30).until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(DirSalesProductBasket.lineItemsProductBasketTable)));
			
			driver.findElement(By.xpath(DirSalesProductBasket.lineItemsProductBasketTable)).click();

//			Thread.sleep(5000);

			new WebDriverWait(driver, 30).until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath(DirSalesProductBasket.tableLineItems + "/div[1]")));
	...
	public static boolean checkRecurringPricesVSProductConfiguration(List<TestLog> logStream, WebDriver driver,
			int stepID, String productName, String configurationIndex) throws Exception {
		int row = 0, col = 0;
		// Variable configurationIndex must have value contractMigrationBridge for all
		// products

		String actionName = "checkRecurringPricesVSProductConfiguration";
		...
		try {
			...
			case "configurationByDefaultContractMigrationBridge":

				displayLineItemsTable(logStream, driver, stepID);
//				System.out.println(productName);
				...
				case "Enterprise Voice":
					...
					int totalRows = driver
							.findElements(By.xpath("//*[@aria-label='Line items and charges']/div[@row='lineItems']"))
							.size();
					int totalColumns = driver.findElements(By.xpath("(//*[@aria-label='Line items and charges']//*[@row='lineItems'])[6]//*[@role='gridcell']")).size();

//					String [][] expectedLineItemsTable = new String [totalRows][totalColumns];
//					System.out.println("Size: " + rowsLineItems.size());

//					(//*[@aria-label='Line items and charges']//*[@row='lineItems'])[2]//*[@role='gridcell'][4]//*[@class="btn-status recurring"]

					String[][] expectedLineItemsTable = {
							{ "Bizz IP Box - 2B/2V/S4E - One-Time Charge", "1", "0,00", "false" },
							{ "Bizz IP Box - 2B/2V/S4E - Recurring Charge", "1", "0,00", "true" },
							{ "Bizz IP Box Other IPBX - One-Time Charge", "1", "0,00", "false" },
							{ "Bizz IP Box Other IPBX - Recurring Charge", "1", "6,50", "true" },
							{ "Enterprise Voice - 10 Channels - Recurring Charge", "1", "198,48", "true" },
							{ "VoIP Individual number - Recurring Charge", "5", "1,49", "true" } };

					// Loop for the Line Item Table on GUI
					for (row = 1; (row <= totalRows); row++) {
						for (col = 1; (col <= totalColumns); col++) {

							WebElement cell = driver.findElement(
									By.xpath("(//*[@aria-label='Line items and charges']//*[@row='lineItems'])[" + row
											+ "]" + "//*[@role='gridcell'][" + col + "]"));
							

							if (cell.getText().contains(expectedLineItemsTable[row][col]) == true && col != totalColumns) {
								validation = true;
								System.out.println("Row[" + row + "]" + " and Column [" + col + "]: " + cell.getText());

							} else {
								validation = false;
							}

							if ((col == totalColumns && BrowserActions.isElementPresent(driver,
									"(//*[@aria-label='Line items and charges']//*[@row='lineItems'])[" + row + "]"
											+ "//*[@role='gridcell'][" + col
											+ "]//*[@class='btn-status recurring']") == true)) {
								validation = true;
								System.out.println(BrowserActions.isElementPresent(driver,
										"(//*[@aria-label='Line items and charges']//*[@row='lineItems'])[" + row + "]"
												+ "//*[@role='gridcell'][" + col
												+ "]//*[@class='btn-status recurring']"));
				...
				default:
					TestLogger.logDebug(logStream, "checkRecurringPricesForContractTypeSelected",
							"productName: '" + productName + "' is not valid.");
					validation = false;
				}
			...
			default:
				...
				TestLogger.logDebug(logStream, "checkRecurringPricesForContractTypeSelected",
						"configurationIndex: '" + configurationIndex + "' is not valid.");
				validation = false;
			}
