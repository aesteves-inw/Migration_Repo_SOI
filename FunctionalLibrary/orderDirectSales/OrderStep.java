...
public class OrderStep 
{
	...
	public static void submitOrderNegativeVal(List<TestStepReportStructure> testExecStructure,
			List<TestLog> logStream, WebDriver driver, String testName) throws Exception 
	{ 
		int stepID=TestExecutionReport.stepOfTestStep(testExecStructure);
		...
		try
		{
			...
			validation = OrderAction.submitOrderNegativeVal(logStream, driver, stepID);
	...
	public static void validateContractTypeColumn(List<TestStepReportStructure> testExecStructure,
			List<TestLog> logStream, WebDriver driver, String testName, String contractType) throws Exception 
	{
		...
		String stepNameMin="validateContractTypeColumn";
		...
		try
		{
			validation = OrderAction.validateContractTypeColumn(logStream, driver, stepID, contractType);
	...
	public static void validateServiceRelatedList(List<TestStepReportStructure> testExecStructure,
			List<TestLog> logStream, WebDriver driver, String testName, String productD03) throws Exception 
	{
		int stepID=TestExecutionReport.stepOfTestStep(testExecStructure);
		
		String stepName="Order: validate Service(s) Related List";

		String stepNameMin="validateServiceRelatedList";
