...
public class ActsSalesHomePage {
	...
	public static void login(WebDriver driver, int stepID, String userProfile) throws Exception
	{
		...
		String envURL=TestDataManagement.searchDT(0, "environmentITTQA");

		String[] user = TestDataManagement.getSalesforceUser(userProfile);
	...
	public static void logoutDS(WebDriver driver, int stepID) throws Exception
	{
		...
		try
		{
			String logoutURL=TestDataManagement.searchDT(0, "environmentITTQA")+TestDataManagement.searchDT(0, "logout");
