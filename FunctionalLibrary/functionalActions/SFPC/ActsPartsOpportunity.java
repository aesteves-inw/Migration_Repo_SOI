...
public class ActsPartsOpportunity {
	...
	public static void opportunityNewOpportunityScreen(WebDriver driver, WebDriverWait wait, int stepID, String testExecutionString) throws Exception
	{
		...
		String optyStage=TestDataManagement.searchDT(2, "optyStage");

		String optyForecastCategory=TestDataManagement.searchDT(2, "optyForecastCategory");
	...
	public static void configNewMobileOpportunity(WebDriver driver, WebDriverWait wait, int stepID, String testExecutionString) throws Exception
	{
		...
		String mobileVoice=TestDataManagement.searchDT(3, "mobileVoice");
	...
	public static void configNewNonMobileOpportunity(WebDriver driver, WebDriverWait wait, int stepID, String testExecutionString) throws Exception
	{
		String actionName="Opportunity: Product Configuration without Mobile Voice";
		

		String nonMobileVoice=TestDataManagement.searchDT(4, "product");
		
		//Debug
		System.out.println("configNewNonMobileOpportunity: "+nonMobileVoice);
	...
	public static void configProductConfiguration(WebDriver driver, WebDriverWait wait, int stepID, String testExecutionString) throws Exception
	{
		...
		String[] config2Apply=TestDataManagement.prodConfiguration(1);	
	...
	{
		String actionName="Opportunity: Scroll to Orders Area on Related Menu";
		
		
		try
		{
			
			BrowserActions.verticalScrollByPixs(driver, BrowserActions.getYOfElement(driver, SFPC_Opportunity.ordersArea));		
	...
	public static boolean closedWonOPTYValidation(WebDriver driver, int stepID)
	{
		String actionName="Opportunity: Closed Won Validation";
		
		String closedWonStage="//span[text()='Closed Won']";
		
	  	try
		{
	  		System.out.println("closedWonOPTYValidation: "+BrowserActions.isElementPresent(driver, closedWonStage));
	  		
			if(BrowserActions.isElementPresent(driver, closedWonStage))
			{
				System.out.println(actionName+" - Succeeded in Step: "+stepID);
				return true;
			}
	...
	public static boolean soi68validation(WebDriver driver, int stepID, String testExecutionString)
	{
		 ...
		 String oppiename="OPTY_"+testExecutionString;
		  	...
		  	try
			{
		  		String orderLink=SFPC_Opportunity.ordersArea.concat("//a[contains(.,'"+oppiename+"')]");
		  		
				if(BrowserActions.isElementPresent(driver, orderLink))
				{
					System.out.println(actionName+" - Succeeded in Step: "+stepID);
					return true;
				}
