...
public class ActsPartsHomePage {
	...
	public static void loginSFPC(WebDriver driver, int stepID) throws Exception
	{
		...
		String envURL=TestDataManagement.searchDT(1, "environmentITTQA");

		String username=TestDataManagement.searchDT(1, "envUserNameITTQA");

		String password=TestDataManagement.searchDT(1, "envPasswordITTQA");
	...
	public static void navigate2CompanyDetails(WebDriver driver, String testName, int stepID) throws Exception
	{
		...
		String companyURL=(TestDataManagement.searchDT(1, "environmentITTQA")).concat(TestDataManagement.searchDT(1, "CompanyDetails")).concat(TestDataManagement.tdCompanyID(testName));
