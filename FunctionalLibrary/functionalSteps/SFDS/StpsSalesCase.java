...
public class StpsSalesCase {
	...
	public static TestStepReportStructure caseValidationBySOI880(WebDriver driver, String testName, int stepID) throws Exception
	{
		...
		try
		{
			...
			waitcaseValidationBySOI880.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath(SalesforceCase.keyDetailsArticle), TestDataManagement.tdCompanyName(testName)));
