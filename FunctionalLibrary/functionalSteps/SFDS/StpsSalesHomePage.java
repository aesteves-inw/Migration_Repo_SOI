...
public class StpsSalesHomePage {
	...
	public static TestStepReportStructure navigate2SpecificCompanyDetails(WebDriver driver, int stepID, String testName, String companyUS) throws Exception
	{
		...
		String companyURL = TestDataManagement.searchDT(0, "environmentITTQA").concat(TestDataManagement.searchDT(0, "accountView")).concat(TestDataManagement.tdCompanyID(companyUS)).concat("/view");
	...
	public static TestStepReportStructure navigate2CompanyDetails(WebDriver driver, int stepID, String testName) throws Exception
	{
		...
		String companyURL = TestDataManagement.searchDT(0, "environmentITTQA").concat(TestDataManagement.searchDT(0, "accountView")).concat(TestDataManagement.tdCompanyID(testName)).concat("/view");
	...
	public static TestStepReportStructure logoutSFDS(WebDriver driver, String testName, int stepID) throws Exception
	{
		TestStepReportStructure step;


		String stepName="Logout Salesforce - Direct Sales";

		String stepNameMin="logoutSFDS";
		...
		try
		{
			ActsSalesHomePage.logoutDS(driver, stepID);
			
			
			validation = ActsSalesHomePage.homePageLoginValidation(driver, stepID);
