...
public class DirSalesProducts {
	
	// Products Tab in OPTY's Related Menu
	...
	public static String nextButtonScreen="//button[@title='Next']";
	
	public static String productFixVoiceValueAddedServices="//div[@title='Fix Voice Value Added Services']";
	...
	public static String cancelButtonEdit="//button[@title='Cancel']";
	
	public static String closeWindowButton="//button[@title='Close this window']";
	
	public static String errorIcon="//a[@class='slds-button']";
