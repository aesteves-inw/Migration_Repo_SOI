...
//		}
	...
	public static void screenShotTaking(WebDriver driver, String TestName, String shotName) throws IOException {
		...
		FileHandler.copy(scrFile,
				new File(ExecStructure.testExecutionScreenshotsFolder(TestName) + "\\" + shotName + ".png"));
		System.out.println("ScreenShot Taken - Location: " + ExecStructure.testExecutionScreenshotsFolder(TestName)
				+ "\\" + shotName + ".png");
	...
	public WebElement getElementbyXpath(WebDriver driver, String attribute, String nameOfSalesforceComponent) {
		WebElement element = driver
				.findElement(By.xpath("//*[contains(@" + attribute + ", '" + nameOfSalesforceComponent + "')]"));
		return element;
	}
	...
	public static boolean pdfContentValidationByRegex(String fileLocation, String validRegexPattern) throws Exception {
		...
		Pattern pattern = Pattern.compile(validRegexPattern,
