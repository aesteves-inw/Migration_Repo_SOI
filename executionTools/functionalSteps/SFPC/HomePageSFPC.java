...
import functionalActions.SFPC.HomePage;
...
public class HomePageSFPC {
	...
	public static TestStepReportStructure loginSFPC(WebDriver driver, int stepID, String testName) throws Exception
	{
		...
		try
		{
			HomePage.loginSFPC(driver, stepID);

			validation=HomePage.validateHomePageScreen(driver, stepID);
	...
	public static TestStepReportStructure navigate2CompDetailsPC(WebDriver driver, String testName, int stepID, String testExecutionString) throws Exception
	{
		...
		try
		{
			HomePage.navigate2CompanyDetails(driver, testName, stepID);

			validation=Company.validateCompanyDetailsPage(driver, stepID);
