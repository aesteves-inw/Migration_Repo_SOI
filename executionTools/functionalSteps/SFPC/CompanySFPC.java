...
*/
	...
	public static TestStepReportStructure createNewOpportunity(WebDriver driver, WebDriverWait wait, int stepID, String testName, String testExecutionString) throws Exception
	{
		...
		try
		{
			Company.createNewOpportunity(driver, stepID);
			
			Opportunity.opportunityNewOpportunityScreen(driver, wait, stepID, testExecutionString);

			validation = Opportunity.newOpportunityDetailsPage(driver, testName, stepID, testExecutionString);
