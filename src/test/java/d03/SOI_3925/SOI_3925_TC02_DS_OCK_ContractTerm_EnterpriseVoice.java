...
public class SOI_3925_TC02_DS_OCK_ContractTerm_EnterpriseVoice {
	String testName = "SOI_3925_TC02_DS_OCK_ContractTerm_EnterpriseVoice";
	...
	@Test
	public void SOI_3925_TC02_DS_OCK_ContractTerm_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_3925.SOI_3925_TC02_DS_OCK_ContractTerm_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
