...
public class SOI_3925_TC07_PC_OCK_ContractTerm_Professional_Internet {
	String testName = "SOI_3925_TC07_PC_OCK_ContractTerm_Professional_Internet";
	...
	@Test
	public void SOI_3925_TC07_PC_OCK_ContractTerm_Professional_Internet() throws Exception
	{
		try
		{
			SOI_3925.SOI_3925_TC07_PC_OCK_ContractTerm_Professional_Internet(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
