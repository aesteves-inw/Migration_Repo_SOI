...
public class SOI_4408_TC10_PC_OCK_NewColumns_ECS_InternetProPlus {
	String testName = "SOI_4408_TC10_PC_OCK_NewColumns_ECS_InternetProPlus";
	...
	@Test
	public void SOI_4408_TC10_PC_OCK_NewColumns_ECS_InternetProPlus() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC10_PC_OCK_NewColumns_ECS_InternetProPlus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
