...
public class SOI_4408_TC09_PC_OCK_NewColumns_ECS_FullFiber {
	String testName = "SOI_4408_TC09_PC_OCK_NewColumns_ECS_FullFiber";
	...
	@Test
	public void SOI_4408_TC09_PC_OCK_NewColumns_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC09_PC_OCK_NewColumns_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
