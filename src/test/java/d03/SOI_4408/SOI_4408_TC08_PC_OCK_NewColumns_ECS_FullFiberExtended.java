...
public class SOI_4408_TC08_PC_OCK_NewColumns_ECS_FullFiberExtended {
	String testName = "SOI_4408_TC08_PC_OCK_NewColumns_ECS_FullFiberExtended";
	...
	@Test
	public void SOI_4408_TC08_PC_OCK_NewColumns_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC08_PC_OCK_NewColumns_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
