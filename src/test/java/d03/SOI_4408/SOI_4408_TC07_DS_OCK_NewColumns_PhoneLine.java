...
public class SOI_4408_TC07_DS_OCK_NewColumns_PhoneLine {
	String testName = "SOI_4408_TC07_DS_OCK_NewColumns_PhoneLine";
	...
	@Test
	public void SOI_4408_TC07_DS_OCK_NewColumns_PhoneLine() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC07_DS_OCK_NewColumns_PhoneLine(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
