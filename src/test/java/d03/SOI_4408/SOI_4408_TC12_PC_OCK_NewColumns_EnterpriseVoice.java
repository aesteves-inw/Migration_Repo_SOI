...
public class SOI_4408_TC12_PC_OCK_NewColumns_EnterpriseVoice {
	String testName = "SOI_4408_TC12_PC_OCK_NewColumns_EnterpriseVoice";
	...
	@Test
	public void SOI_4408_TC12_PC_OCK_NewColumns_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC12_PC_OCK_NewColumns_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
