...
public class SOI_4408_TC04_DS_OCK_NewColumns_ECS_InternetPro {
	String testName = "SOI_4408_TC04_DS_OCK_NewColumns_ECS_InternetPro";
	...
	@Test
	public void SOI_4408_TC04_DS_OCK_NewColumns_ECS_InternetPro() throws Exception
	{
		try
		{
			SOI_4408.SOI_4408_TC04_DS_OCK_NewColumns_ECS_InternetPro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
