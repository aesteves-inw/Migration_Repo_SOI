...
public class SOI_3507_TC01_DS_NonQuotableProductsIgnoredFromAgreement 
{
	String testName = "SOI_3507_TC01_DS_NonQuotableProductsIgnoredFromAgreement";
	...
	@Test
	public void SOI_3507_TC01_DS_NonQuotableProductsIgnoredFromAgreement() throws Exception
	{
		try
		{
			SOI_3507.SOI_3507_TC01_DS_NonQuotableProductsIgnoredFromAgreement(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
			System.out.println(e);
			TestLogger.logError(logStream, testName, "Test Execution Failed", e.toString());
			throw new Exception (testName+" - Failed: "+stepsExecuted,e);
		}
	}
