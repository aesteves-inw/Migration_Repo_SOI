...
public class SOI_3889_TC04_DS_OCK_Refactor_MaxVoiceChannels_ECS_FullFiber {
	String testName = "SOI_3889_TC04_DS_OCK_Refactor_MaxVoiceChannels_ECS_FullFiber";
	...
	@Test
	public void SOI_SOI_3889_TC04_DS_OCK_Refactor_MaxVoiceChannels_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_3889.SOI_3889_TC04_DS_OCK_Refactor_MaxVoiceChannels_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
