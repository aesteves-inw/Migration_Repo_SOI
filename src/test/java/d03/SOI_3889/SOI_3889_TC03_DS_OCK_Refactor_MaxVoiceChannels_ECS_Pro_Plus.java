...
public class SOI_3889_TC03_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro_Plus {
	String testName = "SOI_3889_TC03_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro_Plus";
	...
	@Test
	public void SOI_3889_TC03_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro_Plus() throws Exception
	{
		try
		{
			SOI_3889.SOI_3889_TC03_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro_Plus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
