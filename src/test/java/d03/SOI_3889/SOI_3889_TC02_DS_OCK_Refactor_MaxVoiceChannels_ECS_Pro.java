...
public class SOI_3889_TC02_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro {
	String testName = "SOI_3889_TC02_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro";
	...
	@Test
	public void SOI_3889_TC02_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro() throws Exception
	{
		try
		{
			SOI_3889.SOI_3889_TC02_DS_OCK_Refactor_MaxVoiceChannels_ECS_Pro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
