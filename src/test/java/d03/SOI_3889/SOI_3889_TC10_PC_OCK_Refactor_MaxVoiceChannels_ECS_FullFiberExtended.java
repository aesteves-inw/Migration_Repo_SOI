...
public class SOI_3889_TC10_PC_OCK_Refactor_MaxVoiceChannels_ECS_FullFiberExtended {
	String testName = "SOI_3889_TC10_PC_OCK_Refactor_MaxVoiceChannels_ECS_FullFiberExtended";
	...
	@Test
	public void  SOI_3889_TC10_PC_OCK_Refactor_MaxVoiceChannels_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_3889.SOI_3889_TC10_PC_OCK_Refactor_MaxVoiceChannels_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
