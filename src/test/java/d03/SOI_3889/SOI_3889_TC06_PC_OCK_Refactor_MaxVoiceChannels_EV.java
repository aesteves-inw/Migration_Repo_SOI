...
public class SOI_3889_TC06_PC_OCK_Refactor_MaxVoiceChannels_EV{
	String testName = "SOI_3889_TC06_PC_OCK_Refactor_MaxVoiceChannels_EV";
	...
	@Test
	public void  SOI_3889_TC06_PC_OCK_Refactor_MaxVoiceChannels_EV() throws Exception
	{
		try
		{
			SOI_3889.SOI_3889_TC06_PC_OCK_Refactor_MaxVoiceChannels_EV(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
