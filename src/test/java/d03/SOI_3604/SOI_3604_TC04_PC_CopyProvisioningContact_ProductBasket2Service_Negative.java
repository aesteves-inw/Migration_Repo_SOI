...
public class SOI_3604_TC04_PC_CopyProvisioningContact_ProductBasket2Service_Negative 
{
	String testName = "SOI_3604_TC04_PC_CopyProvisioningContact_ProductBasket2Service_Negative";
	...
	@Test
	public void SOI_3604_TC04_PC_CopyProvisioningContact_ProductBasket2Service_Negative() throws Exception
	{
		try
		{
			SOI_3604.SOI_3604_TC04_PC_CopyProvisioningContact_ProductBasket2Service_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
