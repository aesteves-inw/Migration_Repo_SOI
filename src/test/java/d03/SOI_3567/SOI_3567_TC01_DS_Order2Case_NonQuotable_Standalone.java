...
public class SOI_3567_TC01_DS_Order2Case_NonQuotable_Standalone 
{
	String testName = "SOI_3567_TC01_DS_Order2Case_NonQuotable_Standalone";
	...
	public void SOI_3567_TC01_DS_Order2Case_NonQuotable_Standalone() throws Exception
	{
		try
		{
			SOI_3567.SOI_3567_TC01_DS_Order2Case_NonQuotable_Standalone(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
