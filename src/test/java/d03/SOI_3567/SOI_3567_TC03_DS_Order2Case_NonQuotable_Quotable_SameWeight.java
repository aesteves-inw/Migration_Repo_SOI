...
public class SOI_3567_TC03_DS_Order2Case_NonQuotable_Quotable_SameWeight 
{
	String testName = "SOI_3567_TC03_DS_Order2Case_NonQuotable_Quotable_SameWeight";
	...
	@Test
	public void SOI_3567_TC03_DS_Order2Case_NonQuotable_Quotable_SameWeight() throws Exception
	{
		try
		{
			SOI_3567.SOI_3567_TC03_DS_Order2Case_NonQuotable_Quotable_SameWeight(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
