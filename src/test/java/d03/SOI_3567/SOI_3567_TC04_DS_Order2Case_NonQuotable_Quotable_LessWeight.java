...
public class SOI_3567_TC04_DS_Order2Case_NonQuotable_Quotable_LessWeight 
{
	String testName = "SOI_3567_TC04_DS_Order2Case_NonQuotable_Quotable_LessWeight";
	...
	@Test
	public void SOI_3567_TC04_DS_Order2Case_NonQuotable_Quotable_LessWeight() throws Exception
	{
		try
		{
			SOI_3567.SOI_3567_TC04_DS_Order2Case_NonQuotable_Quotable_LessWeight(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
