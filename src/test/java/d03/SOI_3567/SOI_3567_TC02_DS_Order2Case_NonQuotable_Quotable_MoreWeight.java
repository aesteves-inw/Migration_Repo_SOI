...
public class SOI_3567_TC02_DS_Order2Case_NonQuotable_Quotable_MoreWeight 
{
	String testName = "SOI_3567_TC02_DS_Order2Case_NonQuotable_Quotable_MoreWeight";
	...
	public void SOI_3567_TC02_DS_Order2Case_NonQuotable_Quotable_MoreWeight() throws Exception
	{
		try
		{
			SOI_3567.SOI_3567_TC02_DS_Order2Case_NonQuotable_Quotable_MoreWeight(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
