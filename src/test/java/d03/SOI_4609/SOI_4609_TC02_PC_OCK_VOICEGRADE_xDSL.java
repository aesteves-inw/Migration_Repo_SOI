...
public class SOI_4609_TC02_PC_OCK_VOICEGRADE_xDSL {
	String testName = "SOI_4609_TC02_PC_OCK_VOICEGRADE_xDSL";
	...
	@Test
	public void SOI_4609_TC02_PC_OCK_VOICEGRADE_xDSL() throws Exception
	{
		try
		{
			SOI_4609.SOI_4609_TC02_PC_OCK_VOICEGRADE_xDSL(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
