...
public class SOI_3602_TC03_DS_NewBillingAccount_ServiceLevel_Negative_NewExisting {
	String testName = "SOI_3602_TC03_DS_NewBillingAccount_ServiceLevel_Negative_NewExisting";
	...
	@Test
	public void SOI_3602_TC03_DS_NewBillingAccount_ServiceLevel_Negative_NewExisting() throws Exception
	{
		try
		{
			SOI_3602.SOI_3602_TC03_DS_NewBillingAccount_ServiceLevel_Negative_NewExisting(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
