...
public class SOI_4100_DS_TC01_Service_ContractType_ECS_FullFiberExtended {
	String testName = "SOI_4100_DS_TC01_Service_ContractType_ECS_FullFiberExtended";
	...
	@Test
	public void SOI_4100_DS_TC01_Service_ContractType_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_DS_TC01_Service_ContractType_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
