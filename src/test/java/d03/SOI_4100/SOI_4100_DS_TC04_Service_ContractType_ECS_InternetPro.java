...
public class SOI_4100_DS_TC04_Service_ContractType_ECS_InternetPro {
	String testName = "SOI_4100_DS_TC04_Service_ContractType_ECS_InternetPro";
	...
	@Test
	public void SOI_4100_DS_TC04_Service_ContractType_ECS_InternetPro() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_DS_TC04_Service_ContractType_ECS_InternetPro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
