...
public class SOI_4100_PC_TC08_Service_ContractType_ECS_FullFiber {
	String testName = "SOI_4100_PC_TC08_Service_ContractType_ECS_FullFiber";
	...
	@Test
	public void SOI_4100_PC_TC08_Service_ContractType_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_PC_TC08_Service_ContractType_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
