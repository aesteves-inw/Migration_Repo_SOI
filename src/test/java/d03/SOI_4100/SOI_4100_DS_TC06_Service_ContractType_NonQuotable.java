...
public class SOI_4100_DS_TC06_Service_ContractType_NonQuotable {
	String testName = "SOI_4100_DS_TC06_Service_ContractType_NonQuotable";
	...
	@Test
	public void SOI_4100_DS_TC06_Service_ContractType_NonQuotable() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_DS_TC06_Service_ContractType_NonQuotable(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
