...
public class SOI_4100_PC_TC09_Service_ContractType_ECS_InternetProPlus {
	String testName = "SOI_4100_PC_TC09_Service_ContractType_ECS_InternetProPlus";
	...
	@Test
	public void SOI_4100_PC_TC09_Service_ContractType_ECS_InternetProPlus() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_PC_TC09_Service_ContractType_ECS_InternetProPlus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
