...
public class SOI_4100_DS_TC02_Service_ContractType_ECS_FullFiber {
	
	String testName = "SOI_4100_DS_TC02_Service_ContractType_ECS_FullFiber";
	...
	public void SOI_4100_DS_TC01_Service_ContractType_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_DS_TC02_Service_ContractType_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
