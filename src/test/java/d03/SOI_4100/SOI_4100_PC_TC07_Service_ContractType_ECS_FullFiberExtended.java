...
public class SOI_4100_PC_TC07_Service_ContractType_ECS_FullFiberExtended {
	String testName = "SOI_4100_PC_TC07_Service_ContractType_ECS_FullFiberExtended";
	...
	@Test
	public void SOI_4100_PC_TC07_Service_ContractType_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_PC_TC07_Service_ContractType_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
