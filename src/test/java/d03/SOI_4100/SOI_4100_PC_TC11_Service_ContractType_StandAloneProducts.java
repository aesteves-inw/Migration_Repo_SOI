...
public class SOI_4100_PC_TC11_Service_ContractType_StandAloneProducts {
	String testName = "SOI_4100_PC_TC11_Service_ContractType_StandAloneProducts";
	...
	@Test
	public void SOI_4100_PC_TC11_Service_ContractType_StandAloneProducts() throws Exception
	{
		try
		{
			SOI_4100.SOI_4100_PC_TC11_Service_ContractType_StandAloneProducts(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
