...
public class SOI_3792_TC07_PC_OCK_Refactor_BusinessRules_PhoneLine 
{	
	String testName = "SOI_3792_TC07_PC_OCK_Refactor_BusinessRules_PhoneLine";
	...
	@Test
	public void SOI_3792_TC07_PC_OCK_Refactor_BusinessRules_PhoneLine() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC07_PC_OCK_Refactor_BusinessRules_PhoneLine(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
