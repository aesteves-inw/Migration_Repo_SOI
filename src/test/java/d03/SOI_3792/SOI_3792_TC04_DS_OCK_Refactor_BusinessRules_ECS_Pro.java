...
public class SOI_3792_TC04_DS_OCK_Refactor_BusinessRules_ECS_Pro 
{
	...
	@Test
	public void SOI_3792_TC04_DS_OCK_Refactor_BusinessRules_ECS_Pro() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC04_DS_OCK_Refactor_BusinessRules_ECS_Pro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
