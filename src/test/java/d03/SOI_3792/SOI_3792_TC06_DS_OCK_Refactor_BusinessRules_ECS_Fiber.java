...
public class SOI_3792_TC06_DS_OCK_Refactor_BusinessRules_ECS_Fiber 
{
	String testName = "SOI_3792_TC06_DS_OCK_Refactor_BusinessRules_ECS_Fiber";
	...
	@Test
	public void SOI_3792_TC06_DS_OCK_Refactor_BusinessRules_ECS_Fiber() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC06_DS_OCK_Refactor_BusinessRules_ECS_Fiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
