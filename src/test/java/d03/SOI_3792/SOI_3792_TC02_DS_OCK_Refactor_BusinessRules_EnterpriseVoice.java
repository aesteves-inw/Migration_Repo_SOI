...
public class SOI_3792_TC02_DS_OCK_Refactor_BusinessRules_EnterpriseVoice 
{
	String testName = "SOI_3792_TC02_DS_OCK_Refactor_BusinessRules_EnterpriseVoice";
	...
	@Test
	public void SOI_3792_TC02_DS_OCK_Refactor_BusinessRules_EnterpriseVoice() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC02_DS_OCK_Refactor_BusinessRules_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
