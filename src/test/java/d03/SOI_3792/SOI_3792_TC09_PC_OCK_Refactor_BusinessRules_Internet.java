...
public class SOI_3792_TC09_PC_OCK_Refactor_BusinessRules_Internet 
{
	String testName = "SOI_3792_TC09_PC_OCK_Refactor_BusinessRules_Internet";
	...
	@Test
	public void SOI_3792_TC09_PC_OCK_Refactor_BusinessRules_Internet() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC09_PC_OCK_Refactor_BusinessRules_Internet(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
