...
public class SOI_3792_TC11_PC_OCK_Refactor_BusinessRules_ECS_ProPlus 
{
	String testName = "SOI_3792_TC11_PC_OCK_Refactor_BusinessRules_ECS_ProPlus";
	...
	@Test
	public void SOI_3792_TC11_PC_OCK_Refactor_BusinessRules_ECS_ProPlus() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC11_PC_OCK_Refactor_BusinessRules_ECS_ProPlus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
