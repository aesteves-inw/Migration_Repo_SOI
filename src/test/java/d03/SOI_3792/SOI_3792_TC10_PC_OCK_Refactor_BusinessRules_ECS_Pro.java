...
public class SOI_3792_TC10_PC_OCK_Refactor_BusinessRules_ECS_Pro 
{
	String testName = "SOI_3792_TC10_PC_OCK_Refactor_BusinessRules_ECS_Pro";
	...
	@Test
	public void SOI_3792_TC10_PC_OCK_Refactor_BusinessRules_ECS_Pro() throws Exception
	{ 
		try
		{
			SOI_3792.SOI_3792_TC10_PC_OCK_Refactor_BusinessRules_ECS_Pro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
