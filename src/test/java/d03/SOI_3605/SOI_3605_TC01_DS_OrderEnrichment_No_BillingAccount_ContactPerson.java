...
public class SOI_3605_TC01_DS_OrderEnrichment_No_BillingAccount_ContactPerson {
	String testName = "SOI_3605_TC01_DS_OrderEnrichment_No_BillingAccount_ContactPerson";
	...
	@Test
	public void SOI_3605_TC01_DS_OrderEnrichment_No_BillingAccount_ContactPerson() throws Exception
	{
		try
		{
			SOI_3605.SOI_3605_TC01_DS_OrderEnrichment_No_BillingAccount_ContactPerson(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
