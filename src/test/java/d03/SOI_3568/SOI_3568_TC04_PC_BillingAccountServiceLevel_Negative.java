...
public class SOI_3568_TC04_PC_BillingAccountServiceLevel_Negative 
{
	String testName = "SOI_3568_TC04_PC_BillingAccountServiceLevel_Negative";
	...
	{ 
		try
		{
			SOI_3568.SOI_3568_TC04_PC_BillingAccountServiceLevel_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
