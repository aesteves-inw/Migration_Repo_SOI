...
public class SOI_3600_TC01_DS_NewBA_ProductBasket 
{
	String testName = "SOI_3600_TC01_DS_NewBA_ProductBasket";
	...
	public void SOI_3600_TC01_DS_NewBA_ProductBasket() throws Exception
	{
		try
		{
			SOI_3600.SOI_3600_TC01_DS_NewBA_ProductBasket(testExecStructure, logStream, driver, testName); 
		}
		catch(Exception e)
		{
