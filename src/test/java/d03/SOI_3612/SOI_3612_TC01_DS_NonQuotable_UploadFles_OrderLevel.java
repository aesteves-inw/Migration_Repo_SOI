...
public class SOI_3612_TC01_DS_NonQuotable_UploadFles_OrderLevel 
{
	String testName = "SOI_3612_TC01_DS_NonQuotable_UploadFles_OrderLevel";
	...
	@Test
	public void SOI_3612_TC01_DS_NonQuotable_UploadFles_OrderLevel() throws Exception
	{
		try
		{
			SOI_3612.SOI_3612_TC01_DS_NonQuotable_UploadFles_OrderLevel(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
