...
public class SOI_4088_TC12_PC_ContractType_MigrationBridge_FullFiberExtended {
	String testName = "SOI_4088_TC12_PC_ContractType_MigrationBridge_FullFiberExtended";
	...
	@Test
	public void SOI_4088_TC12_PC_ContractType_MigrationBridge_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC12_PC_ContractType_MigrationBridge_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
