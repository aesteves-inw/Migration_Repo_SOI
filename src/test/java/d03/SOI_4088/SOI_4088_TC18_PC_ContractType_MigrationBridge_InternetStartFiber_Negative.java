...
public class SOI_4088_TC18_PC_ContractType_MigrationBridge_InternetStartFiber_Negative {
	String testName = "SOI_4088_TC18_PC_ContractType_MigrationBridge_InternetStartFiber_Negative";
	...
	@Test
	public void SOI_4088_TC18_PC_ContractType_MigrationBridge_InternetStartFiber_Negative() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC18_PC_ContractType_MigrationBridge_InternetStartFiber_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
