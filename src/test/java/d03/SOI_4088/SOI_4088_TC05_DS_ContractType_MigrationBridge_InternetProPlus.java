...
public class SOI_4088_TC05_DS_ContractType_MigrationBridge_InternetProPlus {
	String testName = "SOI_4088_TC05_DS_ContractType_MigrationBridge_InternetProPlus";
	...
	@Test
	public void SOI_4088_TC05_DS_ContractType_MigrationBridge_InternetProPlus() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC05_DS_ContractType_MigrationBridge_InternetProPlus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
