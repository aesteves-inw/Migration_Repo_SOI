...
public class SOI_4088_TC04_DS_ContractType_MigrationBridge_InternetPro {
	String testName = "SOI_4088_TC04_DS_ContractType_MigrationBridge_InternetPro";
	...
	@Test
	public void SOI_4088_TC04_DS_ContractType_MigrationBridge_InternetPro() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC04_DS_ContractType_MigrationBridge_InternetPro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
