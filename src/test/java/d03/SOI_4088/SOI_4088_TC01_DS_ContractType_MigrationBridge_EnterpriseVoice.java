...
public class SOI_4088_TC01_DS_ContractType_MigrationBridge_EnterpriseVoice {
	String testName = "SOI_4088_TC01_DS_ContractType_MigrationBridge_EnterpriseVoice";
	...
	@Test
	public void SOI_4088_TC01_DS_ContractType_MigrationBridge_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC01_DS_ContractType_MigrationBridge_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
