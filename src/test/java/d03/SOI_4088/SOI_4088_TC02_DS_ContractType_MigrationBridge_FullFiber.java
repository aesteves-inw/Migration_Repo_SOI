...
public class SOI_4088_TC02_DS_ContractType_MigrationBridge_FullFiber {
	String testName = "SOI_4088_TC02_DS_ContractType_MigrationBridge_FullFiber";
	...
	@Test
	public void SOI_4088_TC02_DS_ContractType_MigrationBridge_FullFiber() throws Exception
	{
		try
		{
			SOI_4088.SOI_4088_TC02_DS_ContractType_MigrationBridge_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
