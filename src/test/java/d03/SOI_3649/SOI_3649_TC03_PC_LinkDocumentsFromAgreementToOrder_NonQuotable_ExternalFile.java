...
public class SOI_3649_TC03_PC_LinkDocumentsFromAgreementToOrder_NonQuotable_ExternalFile 
{
	String testName = "SOI_3649_TC03_PC_LinkDocumentsFromAgreementToOrder_NonQuotable_ExternalFile";
	...
	@Test
	public void SOI_3649_TC03_PC_LinkDocumentsFromAgreementToOrder_NonQuotable_ExternalFile() throws Exception
	{
		try
		{
			SOI_3649.SOI_3649_TC03_PC_LinkDocumentsFromAgreementToOrder_NonQuotable_ExternalFile(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
