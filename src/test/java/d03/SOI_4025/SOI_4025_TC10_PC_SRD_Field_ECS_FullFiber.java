...
public class SOI_4025_TC10_PC_SRD_Field_ECS_FullFiber {

	String testName = "SOI_4025_TC10_PC_SRD_Field_ECS_FullFiber";
	...
	@Test
	public void SOI_4025_TC10_PC_SRD_Field_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_4025.SOI_4025_TC10_PC_SRD_Field_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
