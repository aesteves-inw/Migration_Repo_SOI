...
public class SOI_4025_TC12_PC_SRD_Field_ECS_Pro {

	String testName = "SOI_4025_TC12_PC_SRD_Field_ECS_Pro";
	...
	@Test
	public void SOI_4025_TC12_PC_SRD_Field_ECS_Pro() throws Exception
	{
		try
		{
			SOI_4025.SOI_4025_TC12_PC_SRD_Field_ECS_Pro(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
