...
public class SOI_4025_TC09_PC_SRD_Field_ECS_FullFiberExtended {

	String testName = "SOI_4025_TC09_PC_SRD_Field_ECS_FullFiberExtended";
	...
	@Test
	public void SOI_4025_TC09_PC_SRD_Field_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4025.SOI_4025_TC09_PC_SRD_Field_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
