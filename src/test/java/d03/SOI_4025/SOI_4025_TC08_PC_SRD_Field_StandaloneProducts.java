...
public class SOI_4025_TC08_PC_SRD_Field_StandaloneProducts {

	String testName = "SOI_4025_TC08_PC_SRD_Field_StandaloneProducts";
	...
	@Test
	public void SOI_4025_TC08_PC_SRD_Field_StandaloneProducts() throws Exception
	{
		try
		{
			SOI_4025.SOI_4025_TC08_PC_SRD_Field_StandaloneProducts(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
