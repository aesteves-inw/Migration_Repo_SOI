...
public class SOI_4025_TC04_DS_SRD_Field_ECS_ProPlus {

	String testName = "SOI_4025_TC04_DS_SRD_Field_ECS_ProPlus";
	...
	@Test
	public void SOI_4025_TC04_DS_SRD_Field_ECS_ProPlus() throws Exception
	{
		try
		{
			SOI_4025.SOI_4025_TC04_DS_SRD_Field_ECS_ProPlus(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
