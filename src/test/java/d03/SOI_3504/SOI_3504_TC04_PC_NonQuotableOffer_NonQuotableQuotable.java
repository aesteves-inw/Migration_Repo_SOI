...
public class SOI_3504_TC04_PC_NonQuotableOffer_NonQuotableQuotable {
	
	String testName = "SOI_3504_TC04_PC_NonQuotableOffer_NonQuotableQuotable";
	...
	@Test
	public void SOI_3504_TC04_PC_NonQuotableOffer_NonQuotableQuotable() throws Exception
	{
		try
		{
			SOI_3504.SOI_3504_TC04_PC_NonQuotableOffer_NonQuotableQuotable(testExecStructure, logStream, driver, stepsExecuted, testName);
		}
		catch(Exception e)
		{
