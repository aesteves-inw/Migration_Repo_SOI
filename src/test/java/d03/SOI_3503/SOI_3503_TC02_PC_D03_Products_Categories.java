...
public class SOI_3503_TC02_PC_D03_Products_Categories {
	String testName = "SOI_3503_TC02_PC_D03_Products_Categories";
	...
	@Test
	public void SOI_3503_TC02_PC_D03_Products_Categories() throws Exception
	{
		try
		{
			SOI_3503.SOI_3503_TC02_PC_D03_Products_Categories(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
