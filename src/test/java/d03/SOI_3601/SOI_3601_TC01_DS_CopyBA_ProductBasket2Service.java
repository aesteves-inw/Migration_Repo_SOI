...
public class SOI_3601_TC01_DS_CopyBA_ProductBasket2Service 
{
	String testName = "SOI_3601_TC01_DS_CopyBA_ProductBasket2Service";
	...
	@Test
	public void SOI_3601_TC01_DS_CopyBA_ProductBasket2Service() throws Exception
	{ 
		try
		{
			SOI_3601.SOI_3601_TC01_DS_CopyBA_ProductBasket2Service(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
