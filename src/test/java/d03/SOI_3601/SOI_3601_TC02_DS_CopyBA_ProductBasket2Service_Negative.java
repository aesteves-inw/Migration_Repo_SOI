...
public class SOI_3601_TC02_DS_CopyBA_ProductBasket2Service_Negative 
{
	String testName = "SOI_3601_TC02_DS_CopyBA_ProductBasket2Service_Negative";
	...
	{ 
		try
		{
			SOI_3601.SOI_3601_TC02_DS_CopyBA_ProductBasket2Service_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
