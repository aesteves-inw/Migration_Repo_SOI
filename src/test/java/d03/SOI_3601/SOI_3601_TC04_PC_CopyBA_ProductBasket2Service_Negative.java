...
public class SOI_3601_TC04_PC_CopyBA_ProductBasket2Service_Negative 
{
	String testName = "SOI_3601_TC04_PC_CopyBA_ProductBasket2Service_Negative";
	...
	@Test
	public void SOI_3601_TC04_PC_CopyBA_ProductBasket2Service_Negative() throws Exception
	{ 
		try
		{
			SOI_3601.SOI_3601_TC04_PC_CopyBA_ProductBasket2Service_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
