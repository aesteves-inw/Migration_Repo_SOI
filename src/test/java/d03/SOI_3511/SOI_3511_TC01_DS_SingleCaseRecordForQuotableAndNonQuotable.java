...
public class SOI_3511_TC01_DS_SingleCaseRecordForQuotableAndNonQuotable 
{
	String testName = "SOI_3511_TC01_DS_SingleCaseRecordForQuotableAndNonQuotable";
	...
	@Test
	public void SOI_3511_TC01_DS_SingleCaseRecordForQuotableAndNonQuotable() throws Exception
	{ 
		try
		{
			SOI_3511.SOI_3511_TC01_DS_SingleCaseRecordForQuotableAndNonQuotable(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
