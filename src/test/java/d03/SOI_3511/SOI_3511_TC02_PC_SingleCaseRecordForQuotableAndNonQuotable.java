...
public class SOI_3511_TC02_PC_SingleCaseRecordForQuotableAndNonQuotable 
{
	String testName = "SOI_3511_TC02_PC_SingleCaseRecordForQuotableAndNonQuotable";
	...
	{ 
		try
		{
			SOI_3511.SOI_3511_TC02_PC_SingleCaseRecordForQuotableAndNonQuotable(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
