...
public class SOI_3566_TC01_DS_ProductModellingSingleProducts 
{
	String testName = "SOI_3566_TC01_DS_ProductModellingSingleProducts";
	...
	@Test
	public void SOI_3566_TC01_DS_ProductModellingSingleProducts() throws Exception
	{
		try
		{
			SOI_3566.SOI_3566_TC01_DS_ProductModellingSingleProducts(testExecStructure, logStream, testName, driver);
		}
		catch(Exception e)
		{
