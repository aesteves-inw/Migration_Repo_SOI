...
public class SOI_3791_TC01_DS_OCK_ErrorHandling {
	String testName = "SOI_3791_TC01_DS_OCK_ErrorHandling";
	...
	@Test
	public void SOI_3791_TC01_DS_OCK_ErrorHandling() throws Exception
	{
		try
		{
			SOI_3791.SOI_3791_TC01_DS_OCK_ErrorHandling(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
