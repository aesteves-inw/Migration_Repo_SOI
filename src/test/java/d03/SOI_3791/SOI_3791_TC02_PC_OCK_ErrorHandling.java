...
public class SOI_3791_TC02_PC_OCK_ErrorHandling {
	String testName = "SOI_3791_TC02_PC_OCK_ErrorHandling";
	...
	@Test
	public void SOI_3791_TC02_PC_OCK_ErrorHandling() throws Exception
	{
		try
		{
			SOI_3791.SOI_3791_TC02_PC_OCK_ErrorHandling(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
