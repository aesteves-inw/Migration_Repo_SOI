...
public class SOI_3611_TC02_PC_NonQuotable_AgreementUpload {
 
	String testName = "SOI_3611_TC02_PC_NonQuotable_AgreementUpload";
	...
	@Test
	public void SOI_3611_TC02_PC_NonQuotable_AgreementUpload() throws Exception
	{
		try
		{
			SOI_3611.SOI_3611_TC02_PC_NonQuotable_AgreementUpload(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
