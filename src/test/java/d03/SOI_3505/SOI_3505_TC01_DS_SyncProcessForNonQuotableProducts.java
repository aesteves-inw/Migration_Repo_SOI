...
public class SOI_3505_TC01_DS_SyncProcessForNonQuotableProducts 
{
	String testName = "SOI_3505_TC01_DS_SyncProcessForNonQuotableProducts";
	...
	@Test
	public void SOI_3505_TC01_DS_SyncProcessForNonQuotableProducts() throws Exception
	{ 
		try
		{
			SOI_3505.SOI_3505_TC01_DS_SyncProcessForNonQuotableProducts(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
