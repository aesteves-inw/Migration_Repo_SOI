...
public class SOI_3505_TC02_DS_SyncProcessForNonQuotableProducts_NonQuotable_Quo_StandAlone 
{
	String testName = "SOI_3505_TC02_DS_SyncProcessForNonQuotableProducts_NonQuotable_Quo_StandAlone";
	...
	{ 
		try
		{
			SOI_3505.SOI_3505_TC02_DS_SyncProcessForNonQuotableProducts_NonQuotable_Quo_StandAlone(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
