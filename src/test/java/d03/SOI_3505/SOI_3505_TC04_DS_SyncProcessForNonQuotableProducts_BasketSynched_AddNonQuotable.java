...
public class SOI_3505_TC04_DS_SyncProcessForNonQuotableProducts_BasketSynched_AddNonQuotable 
{
	String testName = "SOI_3505_TC04_DS_SyncProcessForNonQuotableProducts_BasketSynched_AddNonQuotable";
	...
	{ 
		try
		{
			SOI_3505.SOI_3505_TC04_DS_SyncProcessForNonQuotableProducts_BasketSynched_AddNonQuotable(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
