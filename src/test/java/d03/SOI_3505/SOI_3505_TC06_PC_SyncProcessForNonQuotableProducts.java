...
public class SOI_3505_TC06_PC_SyncProcessForNonQuotableProducts 
{
	String testName = "SOI_3505_TC06_PC_SyncProcessForNonQuotableProducts";
	...
	{ 
		try
		{
			SOI_3505.SOI_3505_TC06_PC_SyncProcessForNonQuotableProducts(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
