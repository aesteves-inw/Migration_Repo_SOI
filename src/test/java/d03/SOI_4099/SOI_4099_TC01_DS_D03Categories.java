...
public class SOI_4099_TC01_DS_D03Categories {
	String testName = "SOI_4099_TC01_DS_D03Categories";
	...
	@Test
	public void SOI_4099_TC01_DS_D03Categories() throws Exception
	{
		try
		{
			SOI_4099.SOI_4099_TC01_DS_D03Categories(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
