...
public class SOI_4410_TC01_DS_OCK_VOICEGRADE_VDSL {
	String testName = "SOI_4410_TC01_DS_OCK_VOICEGRADE_VDSL";
	...
	@Test
	public void SOI_4410_TC01_DS_OCK_VOICEGRADE_VDSL() throws Exception
	{
		try
		{
			SOI_4410.SOI_4410_TC01_DS_OCK_VOICEGRADE_VDSL(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
