...
public class SOI_3930_TC05_DS_D03PlaceHolders_Section_DNSWebhosting {
	String testName = "SOI_3930_TC05_DS_D03PlaceHolders_Section_DNSWebhosting";
	...
	@Test
	public void SOI_3930_TC05_DS_D03PlaceHolders_Section_DNSWebhosting() throws Exception
	{
		try
		{
			SOI_3930.SOI_3930_TC05_DS_D03PlaceHolders_Section_DNSWebhosting(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
