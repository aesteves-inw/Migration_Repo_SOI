...
public class SOI_3930_TC22_PC_D03PlaceHolders_Section_NetwConnServ {
	String testName = "SOI_3930_TC22_PC_D03PlaceHolders_Section_NetwConnServ";
	...
	@Test
	public void SOI_3930_TC22_PC_D03PlaceHolders_Section_NetwConnServ() throws Exception
	{
		try
		{
			SOI_3930.SOI_3930_TC22_PC_D03PlaceHolders_Section_NetwConnServ(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
