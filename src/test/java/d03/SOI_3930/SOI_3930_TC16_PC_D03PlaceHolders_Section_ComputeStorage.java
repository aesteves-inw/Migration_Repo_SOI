...
public class SOI_3930_TC16_PC_D03PlaceHolders_Section_ComputeStorage {
	String testName = "SOI_3930_TC16_PC_D03PlaceHolders_Section_ComputeStorage";
	...
	@Test
	public void SOI_3930_TC16_PC_D03PlaceHolders_Section_ComputeStorage() throws Exception
	{
		try
		{
			SOI_3930.SOI_3930_TC16_PC_D03PlaceHolders_Section_ComputeStorage(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
