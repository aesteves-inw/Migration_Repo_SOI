...
public class SOI_3930_TC20_PC_D03PlaceHolders_Section_MassMarket {
	String testName = "SOI_3930_TC20_PC_D03PlaceHolders_Section_MassMarket";
	...
	@Test
	public void SOI_3930_TC20_PC_D03PlaceHolders_Section_MassMarket() throws Exception
	{
		try
		{
			SOI_3930.SOI_3930_TC20_PC_D03PlaceHolders_Section_MassMarket(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
