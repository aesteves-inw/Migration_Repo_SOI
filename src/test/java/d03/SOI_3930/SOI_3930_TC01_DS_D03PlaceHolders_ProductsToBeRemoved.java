...
public class SOI_3930_TC01_DS_D03PlaceHolders_ProductsToBeRemoved {
	String testName = "SOI_3930_TC01_DS_D03PlaceHolders_ProductsToBeRemoved";
	...
	@Test
	public void SOI_3930_TC01_DS_D03PlaceHolders_ProductsToBeRemoved() throws Exception
	{
		try
		{
			SOI_3930.SOI_3930_TC01_DS_D03PlaceHolders_ProductsToBeRemoved(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
