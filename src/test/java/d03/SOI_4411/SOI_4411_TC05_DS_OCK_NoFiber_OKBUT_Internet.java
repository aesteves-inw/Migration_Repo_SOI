...
public class SOI_4411_TC05_DS_OCK_NoFiber_OKBUT_Internet {
	String testName = "SOI_4411_TC05_DS_OCK_NoFiber_OKBUT_Internet";
	...
	@Test
	public void SOI_4411_TC05_DS_OCK_NoFiber_OKBUT_Internet() throws Exception
	{
		try
		{
			SOI_4411.SOI_4411_TC05_DS_OCK_NoFiber_OKBUT_Internet(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
