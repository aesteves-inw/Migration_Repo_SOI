...
public class SOI_4411_TC12_PC_OCK_NoFiber_NOK_FullFiberExtended {
	String testName = "SOI_4411_TC12_PC_OCK_NoFiber_NOK_FullFiberExtended";
	...
	@Test
	public void SOI_4411_TC12_PC_OCK_NoFiber_NOK_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_4411.SOI_4411_TC12_PC_OCK_NoFiber_NOK_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
