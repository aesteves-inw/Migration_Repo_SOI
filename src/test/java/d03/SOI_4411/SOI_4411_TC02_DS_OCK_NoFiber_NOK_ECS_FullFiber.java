...
public class SOI_4411_TC02_DS_OCK_NoFiber_NOK_ECS_FullFiber {
	String testName = "SOI_4411_TC02_DS_OCK_NoFiber_NOK_ECS_FullFiber";
	...
	@Test
	public void SOI_4411_TC02_DS_OCK_NoFiber_NOK_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_4411.SOI_4411_TC02_DS_OCK_NoFiber_NOK_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
