...
public class SOI_4411_TC08_DS_OCK_NoFiber_NOK_EnterpriseVoice {
	String testName = "SOI_4411_TC08_DS_OCK_NoFiber_NOK_EnterpriseVoice";
	...
	@Test
	public void SOI_4411_TC08_DS_OCK_NoFiber_NOK_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_4411.SOI_4411_TC08_DS_OCK_NoFiber_NOK_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
