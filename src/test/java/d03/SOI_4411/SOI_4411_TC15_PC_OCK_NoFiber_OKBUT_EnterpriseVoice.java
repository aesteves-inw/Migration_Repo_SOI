...
public class SOI_4411_TC15_PC_OCK_NoFiber_OKBUT_EnterpriseVoice {
	String testName = "SOI_4411_TC15_PC_OCK_NoFiber_OKBUT_EnterpriseVoice";
	...
	@Test
	public void SOI_4411_TC15_PC_OCK_NoFiber_OKBUT_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_4411.SOI_4411_TC15_PC_OCK_NoFiber_OKBUT_EnterpriseVoice(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
