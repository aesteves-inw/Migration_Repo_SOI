...
public class SOI_3569_TC05_PC_TechnicalContactServiceLevel_New 
{
	String testName = "SOI_3569_TC05_PC_TechnicalContactServiceLevel_New";
	...
	@Test
	public void SOI_3569_TC05_PC_TechnicalContactServiceLevel_New() throws Exception
	{ 
		try
		{
			SOI_3569.SOI_3569_TC05_PC_TechnicalContactServiceLevel_New(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
