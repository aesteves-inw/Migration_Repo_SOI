...
public class SOI_3569_TC08_PC_TechnicalContactServiceLevel_OE_Deprecated 
{
	String testName = "SOI_3569_TC08_PC_TechnicalContactServiceLevel_OE_Deprecated";
	...
	{ 
		try
		{
			SOI_3569.SOI_3569_TC08_PC_TechnicalContactServiceLevel_OE_Deprecated(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
