...
public class SOI_3569_TC01_DS_TechnicalContactServiceLevel_New {
	...
	public void testCase() throws Exception
	{
		try
		{
			SOI_3569.SOI_3569_TC01_DS_TechnicalContactServiceLevel_New(testExecStructure, logStream, driver, stepsExecuted, testName);
		}
		catch(Exception e)
		{
...
public class SOI_3569_TC01_DS_TechnicalContactServiceLevel_New 
{
	...
	{ 
		try
		{
			SOI_3569.SOI_3569_TC01_DS_TechnicalContactServiceLevel_New(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
			System.out.println(e);
