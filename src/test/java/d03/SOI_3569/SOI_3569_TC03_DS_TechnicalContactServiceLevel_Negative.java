...
public class SOI_3569_TC03_DS_TechnicalContactServiceLevel_Negative 
{
	String testName = "SOI_3569_TC03_DS_TechnicalContactServiceLevel_Negative";
	...
	@Test
	public void SOI_3569_TC03_DS_TechnicalContactServiceLevel_Negative() throws Exception
	{ 
		try
		{
			SOI_3569.SOI_3569_TC03_DS_TechnicalContactServiceLevel_Negative(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
