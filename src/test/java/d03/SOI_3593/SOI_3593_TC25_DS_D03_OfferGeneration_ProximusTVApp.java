...
public class SOI_3593_TC25_DS_D03_OfferGeneration_ProximusTVApp {
	String testName = "SOI_3593_TC25_DS_D03_OfferGeneration_ProximusTVApp";
	...
	@Test
	public void SOI_3593_TC25_DS_D03_OfferGeneration_ProximusTVApp() throws Exception
	{
		...
		try
		{
			SOI_3593.SOI_3593_TC01_DS_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "Proximus TV App (TV Everywhere)");
			SOI_3593.SOI_3593_TC01_PC_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "Proximus TV App (TV Everywhere)");
