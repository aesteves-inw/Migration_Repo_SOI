...
public class SOI_3593_TC52_DS_D03_OfferGeneration_DirectoryNumber_DDI_ISDN {
	String testName = "SOI_3593_TC52_DS_D03_OfferGeneration_DirectoryNumber_DDI_ISDN";
	...
	@Test
	public void SOI_3593_TC52_DS_D03_OfferGeneration_DirectoryNumber_DDI_ISDN() throws Exception
	{
		...
		try
		{
			SOI_3593.SOI_3593_TC01_DS_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "Directory Number (DDI/ISDN)");
			SOI_3593.SOI_3593_TC01_PC_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "Directory Number (DDI/ISDN)");
