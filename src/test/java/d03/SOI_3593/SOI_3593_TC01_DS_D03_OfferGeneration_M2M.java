...
public class SOI_3593_TC01_DS_D03_OfferGeneration_M2M {
	String testName = "SOI_3593_TC01_DS_D03_OfferGeneration_M2M";
	...
	@Test
	public void SOI_3593_TC01_DS_D03_OfferGeneration_M2M() throws Exception
	{
		...
		try
		{
			SOI_3593.SOI_3593_TC01_DS_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "M2M KORE");
			SOI_3593.SOI_3593_TC01_PC_D03_OfferGeneration_General(testExecStructure, logStream, driver, testName, "M2M KORE");
		}
		catch(Exception e)
		{
