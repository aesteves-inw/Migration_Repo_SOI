...
public class SOI_3603_TC01_DS_Existing_TechnicalContact_PBasketLevel 
{
	String testName = "SOI_3603_TC01_DS_Existing_TechnicalContact_PBasketLevel";
	...
	{ 
		try
		{
			SOI_3603.SOI_3603_TC01_DS_Existing_TechnicalContact_PBasketLevel(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
