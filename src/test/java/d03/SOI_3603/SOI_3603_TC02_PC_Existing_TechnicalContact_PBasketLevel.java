...
public class SOI_3603_TC02_PC_Existing_TechnicalContact_PBasketLevel 
{
	String testName = "SOI_3603_TC02_PC_Existing_TechnicalContact_PBasketLevel";
	...
	@Test
	public void SOI_3603_TC02_PC_Existing_TechnicalContact_PBasketLevel() throws Exception
	{ 
		try
		{
			SOI_3603.SOI_3603_TC02_PC_Existing_TechnicalContact_PBasketLevel(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
