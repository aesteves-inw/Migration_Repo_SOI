...
public class SOI_3610_TC01_DS_SingleOrder_Quotable_NonQuotable 
{
	...
	@Test
	public void SOI_3610_TC01_DS_SingleOrder_Quotable_NonQuotable() throws Exception
	{
		...
		try
		{
			SOI_3610.SOI_3610_TC01_DS_SingleOrder_Quotable_NonQuotable(testExecStructure, logStream, driver, testName, productD03);
		}
		catch(Exception e)
		{
