...
public class SOI_2206_TC04_DS_ECS_Offerings_ECS_ProPlus_PhoneLine 
{
	String testName = "SOI_2206_TC04_DS_ECS_Offerings_ECS_ProPlus_PhoneLine";
	...
	@Test
	public void SOI_2206_TC04_DS_ECS_Offerings_ECS_ProPlus_PhoneLine() throws Exception
	{
		try
		{
			SOI_2206.SOI_2206_TC04_DS_ECS_Offerings_ECS_ProPlus_PhoneLine(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
