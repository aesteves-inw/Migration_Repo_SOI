...
public class SOI_2206_TC12_PC_ECS_PackageContent_ECS_FullFiber 
{
	String testName = "SOI_2206_TC12_PC_ECS_PackageContent_ECS_FullFiber";
	...
	@Test
	public void SOI_2206_TC12_PC_ECS_PackageContent_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_2206.SOI_2206_TC12_PC_ECS_PackageContent_ECS_FullFiber(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
