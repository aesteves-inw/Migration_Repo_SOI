...
public class SOI_2206_TC13_PC_ECS_PackageContent_ECS_FullFiberExtended 
{
	String testName = "SOI_2206_TC13_PC_ECS_PackageContent_ECS_FullFiberExtended";
	...
	@Test
	public void SOI_2206_TC13_PC_ECS_PackageContent_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_2206.SOI_2206_TC13_PC_ECS_PackageContent_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName);
		}
		catch(Exception e)
		{
