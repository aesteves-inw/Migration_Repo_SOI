...
public class SOI_2205_TC13_PC_ECS_Offerings_ECS_FullFiberExtended 
{
	String testName = "SOI_2205_TC13_PC_ECS_Offerings_ECS_FullFiberExtended";
	...
	public void SOI_2205_TC13_PC_ECS_Offerings_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_2205.SOI_2205_TC13_PC_ECS_Offerings_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
