...
public class SOI_2205_TC10_PC_ECS_Offerings_ECS_ProPlus_EnterpriseVoice 
{
	String testName = "SOI_2205_TC10_PC_ECS_Offerings_ECS_ProPlus_EnterpriseVoice";
	...
	@Test
	public void SOI_2205_TC10_PC_ECS_Offerings_ECS_ProPlus_EnterpriseVoice() throws Exception
	{
		try
		{
			SOI_2205.SOI_2205_TC10_PC_ECS_Offerings_ECS_ProPlus_EnterpriseVoice(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
