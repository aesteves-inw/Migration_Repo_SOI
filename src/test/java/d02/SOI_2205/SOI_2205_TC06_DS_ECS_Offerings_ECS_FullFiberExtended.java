...
public class SOI_2205_TC06_DS_ECS_Offerings_ECS_FullFiberExtended
{
	...
	@Test
	public void SOI_2205_TC06_DS_ECS_Offerings_ECS_FullFiberExtended() throws Exception
	{
		try
		{
			SOI_2205.SOI_2205_TC06_DS_ECS_Offerings_ECS_FullFiberExtended(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
