...
public class SOI_2205_TC12_PC_ECS_Offerings_ECS_FullFiber 
{
	String testName = "SOI_2205_TC12_PC_ECS_Offerings_ECS_FullFiber";
	...
	@Test
	public void SOI_2205_TC12_PC_ECS_Offerings_ECS_FullFiber() throws Exception
	{
		try
		{
			SOI_2205.SOI_2205_TC12_PC_ECS_Offerings_ECS_FullFiber(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
