...
public class SOI_2205_TC02_DS_ECS_Offerings_ECS_Pro_PhoneLine 
{
	...
	@Test
	public void SOI_2205_TC02_DS_ECS_Offerings_ECS_Pro_PhoneLine() throws Exception
	{
		try
		{
			SOI_2205.SOI_2205_TC02_DS_ECS_Offerings_ECS_Pro_PhoneLine(testExecStructure, logStream, driver, testName, stepsExecuted);
		}
		catch(Exception e)
		{
