...
public class OrderCreationForNewContract_OrderCreation_From_OPTYClosure_Won_NotMobileVoice {
	...
	public void step05() throws Exception {
		...
		try
		{
			driver.findElement(By.xpath(SalesForceOpportunity.editButton)).click();
			
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(SalesForceOpportunity.editHeader)));
			
			driver.findElement(By.xpath(SalesForceOpportunity.selectStage)).click();
			
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(SalesForceOpportunity.listState)));
			
			BrowserActions.verticalscrollByVisibleElement(driver, SalesForceOpportunity.closeWonOptyStage);
			
			driver.findElement(By.xpath(SalesForceOpportunity.closeWonOptyStage)).click();
			
			driver.findElement(By.xpath(SalesForceOpportunity.nosSaveButton)).click();
			
			wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(SalesForceOpportunity.editHeader)));
